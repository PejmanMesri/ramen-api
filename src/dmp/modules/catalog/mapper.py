...
class UniversityPayload:
    ...
    # All non-empty descriptions, one entry per source:
    # [{"source": "QS", "text": "..."}, {"source": "Shanghai", ...}, ...]
    descriptions: list[dict] = field(default_factory=list)
    # [{"subject": "Ecology", "rank": "76-100"}, ...]
    subject_rankings: list[dict] = field(default_factory=list)
    # {"2015": "701+", ...} — QS historical global rank
